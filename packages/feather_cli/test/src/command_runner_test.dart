...
void main() {
  group('FeatherCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FeatherCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FeatherCliCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = FeatherCliCommandRunner();
